const u="http://localhost:8000/api/zoning";function c(a){return!a&&a!==0?"—":typeof a=="number"?a.toLocaleString():a}function d(a,t,l,r="green",n="red"){return a?`<span class="pill pill-${r}">${t}</span>`:`<span class="pill pill-${n}">${l}</span>`}function e(a,t){return`<div class="data-row"><span class="data-key">${a}</span><span class="data-val">${t??"—"}</span></div>`}function g(a){const t=a.parcel||{},l=a.zoning||{},r=a.overlays||{},n=a.valuation||{},i=a.development_potential||{},o=a.grants||{};let v=`
