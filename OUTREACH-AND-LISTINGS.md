# Outreach Templates & Directory Listing Copy

> Paste-ready content for backlink campaign. Each section is independent — copy what you need.
...
Happy to provide any specifics that would be useful for your guide. No expectation of an editorial swap — if it fits, great; if not, no follow-up.

Daniel Issak
DRE #02037760 · Real Estate Source, Inc. (DRE #01869619)
424-272-5935 · dan.issak@gmail.com
...
- True gated compound layout (not just a driveway gate)
- Heated pool + spa, steam sauna, chef's kitchen with dual sinks/ovens
- Level 2 EV charger, Ring perimeter cameras, smart home HVAC
...
## 4. LUXURY ESTATE.COM Listing Copy

**Listing Title:**
9432 Oakmore Rd — Gated Beverlywood Luxury Compound, Furnished, $34,999/mo
...
## 5. FURNISHED FINDER Listing Copy

**Property Name:** 9432 Oakmore Rd — Gated Beverlywood Compound

**Headline (~80 chars):**
Gated 5BR Beverlywood Compound — Furnished, Heated Pool, Kosher Kitchen, EV Charging

**Description (~500 words):**

Fully furnished 5-bedroom, 6-bath gated luxury compound in Beverlywood, Los Angeles 90035 — Beverly Hills adjacent. The property is a dual-structure layout on a single perimeter-fenced lot: a 4,092 sq ft main residence plus a 400 sq ft fully independent detached guest house with its own kitchen, bathroom, and locking entry.

The compound is built for tenants who need privacy plus working amenities. The chef's kitchen has dual sinks and dual ovens for kosher meat/dairy separation. The primary suite includes a steam sauna. The yard centers on a heated pool and spa with EV charging on-property. The smart-home stack includes multi-zone HVAC, Ring camera coverage of all entries, and smart locks with audit-logged access.

Position is favorable: 5 minutes to the Pico-Robertson kosher corridor, 10 minutes to Beverly Hills, 15 minutes to Century City and Cedars-Sinai, 18 minutes to SoFi Stadium, 20 minutes to LAX. The Beverlywood Homes Association maintains private patrol coverage in the immediate corridor.
...
**Property Website (FILL THIS IN):** https://sevennova.ai/luxury-rental
**Direct Inquiry:** 424-272-5935

---

## 6. MANSION GLOBAL Listing Copy
...
- Gated compound · perimeter fenced · automatic vehicle gate
- Detached 400 sq ft guest house · independent entry · full kitchen
- Heated pool · spa · steam sauna
...
## DELIVERY CHECKLIST (paste-and-send order)

- [ ] Send email #1 (Bedford Housing) — paste from section 1
- [ ] Send email #2 (Nightfall Group) — paste from section 2
- [ ] Send email #3 (Beverly Hills Courier) — paste from section 3
- [ ] Submit LuxuryEstate.com listing — paste from section 4
- [ ] Submit Furnished Finder listing — paste from section 5
- [ ] Submit Mansion Global listing — paste from section 6
- [ ] Add Zillow / Redfin / Apartments.com website field → `https://sevennova.ai/luxury-rental`
